...
SPAWN_RATE="${2:-10}"
DURATION="${3:-60}"
LOAD_TEST_AUDIO="${LOAD_TEST_AUDIO:-auto}"
LOAD_TEST_STREAM_PACE="${LOAD_TEST_STREAM_PACE:-none}"
export LOAD_TEST_AUDIO LOAD_TEST_STREAM_PACE
...
echo "  Audio mode:  $LOAD_TEST_AUDIO"
echo "  Stream pace: $LOAD_TEST_STREAM_PACE"
echo ""
